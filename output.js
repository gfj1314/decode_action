  ...
  async getSignInfo() {
    try {
      ...
      let _0x4ad8f7 = _0x572f41,
        _0x15aac1 = await this.fetch(_0x4ad8f7),
        {
  ...
  async signin() {
    try {
      ...
      let _0x52f8bf = _0x1ad671,
        _0x25dc4b = await this.fetch(_0x52f8bf),
  ...
  async welfareSignin() {
    try {
      let _0x46daa0 = {
        ...
        _0x20a8e4 = await this.fetch(_0x46daa0),
  ...
  async triggerTask(_0x4f5505) {
    try {
      let _0x44a32a = {
        ...
        _0x2e4581 = await this.fetch(_0x44a32a);
  ...
  async sleepSign(_0x16fbb3) {
    ...
    try {
      ...
      let _0x2dc3ef = {
        ...
        _0x585fdb = await this.fetch(_0x2dc3ef);
  ...
  async getCoin() {
    try {
      ...
      let _0x1b74c5 = _0x55ca99,
        _0x1927de = await this.fetch(_0x1b74c5);
  ...
  async carbonSignin() {
    try {
      let _0x53c6e0 = {
        ...
        _0x7dd2f4 = await this.fetch(_0x53c6e0),
  ...
  async carbonCoin() {
    try {
      ...
      let _0x30b0bf = _0x4cdaa7,
        _0x1d0aa7 = await this.fetch(_0x30b0bf);
  ...
  async carbonTravelQuery() {
    try {
      ...
      let _0x312230 = _0x1b3c44,
        _0x2395ea = await this.fetch(_0x312230),
  ...
  async getReceiveEngeryList() {
    try {
      ...
      let _0x149a71 = _0x32998d,
        _0x155e1b = await this.fetch(_0x149a71);
  ...
  async receiveEngery(_0x57ed5b) {
    try {
      ...
      let _0x4a0aa7 = _0x456584,
        _0x2c573b = await this.fetch(_0x4a0aa7);
...
async function getUserInfo(_0x396a2e) {
  try {
    ...
    let _0x56c799 = _0x86e76b,
      _0x3334a4 = await Request(_0x56c799);

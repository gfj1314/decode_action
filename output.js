...
class _0x58be19 {
  ...
  async taskApi(_0x592850 = {}) {
    ...
    try {
      ...
      if (_0x592850.body) {
        _0x158083.headers["Content-Type"] = _0x592850["Content-Type"] || _0xc19d3;
        if (typeof _0x592850.body === "object") {
          if (_0x158083.headers["Content-Type"].includes("json")) {
            _0x158083.body = JSON.stringify(_0x592850.body);
          } else {
            ...
            _0x158083.body = _0x347eb6.json2str(_0x592850.body, "&");
          }
        } else {
          _0x158083.body = _0x592850.body;
        }
        _0x347eb6.isNode() ? _0x158083.headers["Content-Length"] = _0x158083.body ? Buffer.byteLength(_0x158083.body, "utf8") : 0 : _0x158083.headers["Content-Length"] = _0x158083.body ? _0x158083.body.length : 0;
      }
      if (_0x592850.urlObjectParam) {
        Object.assign(_0x158083, _0x592850.urlObjectParam);
      }
      if (_0x592850.headerParam) {
        Object.assign(_0x158083.headers, _0x592850.headerParam);
      }
      if (_0x592850.debugIn) {
        console.log(_0x158083);
      }
      _0x2426f8 = Object.assign({}, await _0x56b20b(_0x592850.method, _0x158083));
  ...
  async refresh_cookie(_0x15d123 = {}) {
    ...
    try {
      ...
      _0x10c88f = Object.assign({}, await this.taskApi(_0x5e28af));
  ...
  async personalInfo(_0x539f3f = {}) {
    ...
    try {
      ...
      _0x19d2fb = Object.assign({}, await this.taskApi(_0x16eccb));
  ...
  async automaticSignFetchPackage(_0x172698, _0x50b1d0 = {}) {
    ...
    try {
      ...
      let _0x5bb111 = _0x3196f7;
      _0x4c5f8f = Object.assign({}, await this.taskApi(_0x5bb111));
  ...
  async finishTask(_0x28d86c, _0x1ab90e = {}) {
    ...
    try {
      ...
      _0x57b744 = Object.assign({}, await this.taskApi(_0xb61a27));
  ...
  async fetchIntegral(_0x5270b0, _0x3a2b3f = {}) {
    ...
    try {
      ...
      _0x8186a7 = Object.assign({}, await this.taskApi(_0x3b74ac));
  ...
  async queryPointTaskAndSign(_0xff8004 = {}) {
    ...
    try {
      ...
      let _0x2afe11 = _0x7fd38a;
      _0xe8c49c = Object.assign({}, await this.taskApi(_0x2afe11));
  ...
  async scanPageToRecord(_0x41de9c, _0x6131b1 = {}) {
    ...
    try {
      ...
      _0x36c7be = Object.assign({}, await this.taskApi(_0x28d297));
  ...
  async fetchPoint(_0x39a43c, _0x51b326 = {}) {
    ...
    try {
      ...
      _0x19451a = Object.assign({}, await this.taskApi(_0xf010e4));
...
async function _0x4da6df(_0x58789e = 0) {
  ...
  try {
    let _0x4e6776 = {
      ...
      _0x34d6eb = null,
      _0x3d91ea = await _0x56b20b("get", _0x4e6776);
    if (_0x3d91ea.err) {
  ...
  return new class {
    ...
    send(_0x468976, _0x21faf7, _0x29871e = () => {}) {
      ...
      if (this.isSurge() || this.isLoon()) {
        ...
        if (_0x468976 == "get") {
          delete _0xf26864.data;
        }
        $axios(_0xf26864).then(_0x253df0 => {
          const {
              status: _0x32e544,
              request: _0x204ebf,
              headers: _0x48d441,
